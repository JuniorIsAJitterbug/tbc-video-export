        ...
        self.assertEqual(
            ...
            " ".join(
                [
                    ...
                    "-i PIPE_IN",
                    "-filter_complex",
                    "[0:v]format=gray16le[luma];"
                    "[1:v]format=yuv444p16le[chroma];"
                    "[luma]extractplanes=y[y];"
                    "[chroma]extractplanes=u+v[u][v];"
                    "[y][u][v]mergeplanes=0x001020:format=yuv444p16le,setfield=tff,format=yuv422p10le[v_output]",
                    "-map [v_output]",
        ...
        self.assertEqual(
            ...
            " ".join(
                [
                    ...
                    "-i PIPE_IN",
                    "-filter_complex",
                    "[0:v]setfield=tff,format=gray16le[v_output]",
                    "-map [v_output]",
                    "-timecode 00:00:00:00",
                    "-framerate pal",
                    "-color_range tv",
