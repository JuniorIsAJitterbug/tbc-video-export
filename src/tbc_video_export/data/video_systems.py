...
_video_systems: Final[dict[VideoSystem, VideoSystemData]] = {
    VideoSystem.PAL: VideoSystemData(
        size={
    ...
    VideoSystem.NTSC: VideoSystemData(
        size={
    ...
    VideoSystem.PAL_M: VideoSystemData(
        size={
            "default": VideoSystemData.Size(760, 488),  # unused
...
VideoSizeType: TypeAlias = Literal[
    "default",
    "4fsc",
]
...
VideoAspectRatioType: TypeAlias = Literal[
    "default",
    "widescreen",
    "letterbox",
]
