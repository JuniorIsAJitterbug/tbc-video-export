...
DEFAULT_CONFIG: JsonConfig = {
    ...
    "video_profiles": [
        ...
        {
            "name": "x264_web_vaapi",
            "description": "H.264 AVC - VA-API - Web",
            "codec": "h264_vaapi",
            "video_format": "nv12",
            "container": "mov",
            "opts": [
        ...
        {
            "name": "av1_web_nvenc",
            "description": "AV1 - Nvidia NVENC - Web",
            "codec": "av1_nvenc",
            "video_format": "nv12",
            "container": "mov",
            "opts": [
        ...
        {
            "name": "xav1_web_quicksync",
            "description": "AV1 - Intel QuickSync - Web",
            "codec": "av1_qsv",
            "video_format": "nv12",
            "container": "mov",
            "opts": [
